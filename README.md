...
- консервативный граф вызовов/создания объектов для TypeScript/JavaScript, Java, Go, Rust, C# и PHP;
...
1. Опциональный sandboxed LSP-режим с явным согласием пользователя для более точного разрешения динамических вызовов.
2. Kotlin Tree-sitter WASM-адаптер.
3. Desktop-оболочка Tauri для системного выбора папки.
