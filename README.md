...
- drag-and-drop узлов, ручные архитектурные и OOP-связи, инспектор свойств, статусы, владелец, undo/redo и сохранение blueprint отдельно от исходного проекта;
- библиотека из 10 готовых пресетов: Modular Monolith, Microservices, Event-driven/CQRS, Hexagonal Architecture и OOP-паттерны Strategy, Factory Method, Observer, Adapter, Decorator и Repository;
